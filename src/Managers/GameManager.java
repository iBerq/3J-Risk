...
public class GameManager implements Initializable {
    ...
    @FXML
    public Pane c1_img, c2_img, c3_img, c4_img, c5_img, c6_img, c7_img, c8_img, c9_img, c10_img, c11_img, map_pane,
            settings_pane, cards_pane, howToPlay_pane;
    @FXML
    public ImageView img1, img2, img3, img4, img5, img6, img7, img8, img9, img10, img11, img12, img13, img14, img15,
            ...
            img31, img32, img33, img34, img35, img36, cards_img, chosenCard1, chosenCard2, chosenCard3;
    @FXML
    public Label num1_lbl, num2_lbl, num3_lbl, num4_lbl, num5_lbl, num6_lbl, num7_lbl, num8_lbl, num9_lbl, num10_lbl,
            num11_lbl, num12_lbl, num13_lbl, num14_lbl, num15_lbl, num16_lbl, num17_lbl, num18_lbl, num19_lbl,
            num20_lbl, num21_lbl, num22_lbl, num23_lbl, num24_lbl, num25_lbl, num26_lbl, num27_lbl, num28_lbl,
            num29_lbl, num30_lbl, num31_lbl, num32_lbl, num33_lbl, num34_lbl, num35_lbl, num36_lbl, p1Nick_lbl,
            p1hacker_lbl, p1CountryNum_lbl, p2Nick_lbl, p2hacker_lbl, p2CountryNum_lbl, p3Nick_lbl, p3hacker_lbl,
            p3CountryNum_lbl, p4Nick_lbl, p4hacker_lbl, p4CountryNum_lbl, cardInfo_lbl, infoGame_lbl, hacker_lbl;
    @FXML
    public Slider sound_slider;
    @FXML
    public VBox attackerDice_vbox, defenderDice_vbox, nicknames_vbox;
    @FXML
    public HBox cards_hbox, p1_hbox, p2_hbox, p3_hbox, p4_hbox;
    @FXML
    public Button hire_btn, hack_btn, fortify_btn, nextPhase_btn, combineCards_btn, howToPlay_btn, settings_btn;
    @FXML
    public SplitMenuButton hackerNum_menu;
    @FXML
    public GridPane p1_grid, p2_grid, p3_grid, p4_grid;
    ...
    public void setPhase() {
        if (turnType == 1) {
            ...
            cardInfo_lbl.setText("You can combine your cards to get extra hackers.");
        } else if (turnType == 2) {
            ...
            cardInfo_lbl.setText("You can combine cards only in Hire Phase.");
        } else if (turnType == 3) {
    ...
    public ArrayList<Integer> generateRandomCountryNumbers() {
        ...
        while (counter != countryNumbers.length) {
            ...
            for (int countryNumber : countryNumbers) {
                if (countryNumber == randomNumber) {
                    isThere = true;
                    break;
                }
            }
            for (Integer givenCountry : givenCountries) {
                if (givenCountry == randomNumber) {
                    isThere = true;
                    break;
                }
            }
    ...
    public void assignHackerNumsToCountries() {
        ...
        for (Country country : allCountries) {
            ...
            } else if (checker.toString().equals("") || checker.toString().equals(".")) {
    ...
    public void combineCardsClicked() {
        ...
        if (chosenCard1.getImage().impl_getUrl().equals(lCard.impl_getUrl()) && chosenCard2.getImage().impl_getUrl().equals(lCard.impl_getUrl()) && chosenCard3.getImage().impl_getUrl().equals(bCard.impl_getUrl())) {
            ...
            cardInfo_lbl.setText("Please enter cards according to the guide.");
            return;
        }
        updateCardsScene();
        cardInfo_lbl.setText("Bonus hackers successfully added! Returning to the game");
        setHackerNumMenu(players.get(turnOwner - 1).getNumOfBonusHackers(), false, false);
        try {
